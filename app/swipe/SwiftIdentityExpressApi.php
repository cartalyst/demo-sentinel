...
class SwiftIdentityExpressAPI extends ApiBase{
...
function __construct($url) {
	 ...
	 public function enableSms($anApplicationCode)
	{
	 ...
	 public function apiSwiftTokenLogin($aSwiftToken,$anApiKey)
	{
		 return parent::callServer("api-swift-token-login", array($aSwiftToken,$anApiKey));
	}
